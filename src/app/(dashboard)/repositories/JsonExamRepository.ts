/**
 * JSON Exam Repository Implementation
 * Loads exam data from JSON files - Client-side compatible
 */
...
export class JsonExamRepository implements IExamRepository {
  ...
  /**
   * Initialize repository by loading JSON data
   */
  private async initialize(): Promise<void> {
    ...
    try {
      ...
      data.questions.forEach((jsonQuestion) => {
      ...
      throw new Error('Failed to initialize JSON repository');
    }
  }
